...
def send():
	...
	print('Account balance',fContract.call({'from': '0xFed55B453dBb0589ec5433a9318C09f1766D7dAb'}).balanceOf('0xFed55B453dBb0589ec5433a9318C09f1766D7dAb'))
	call_data = fContract.encodeABI('transfer',["0xa5Acc472597C1e1651270da9081Cc5a0b38258E3",int(total)])
